...
void* threadfunc(void* thread_param)
{
    ...
    rc = pthread_mutex_lock(thread_func_args->mutex); // returns 0 when lcoking is successful
...
bool start_thread_obtaining_mutex(pthread_t *thread, pthread_mutex_t *mutex,int wait_to_obtain_ms, int wait_to_release_ms)
{
    ...
    th_data->mutex = mutex;
    th_data->wait_to_obtain_us = wait_to_obtain_ms*1000;
    th_data->wait_to_release_us = wait_to_release_ms*1000;
